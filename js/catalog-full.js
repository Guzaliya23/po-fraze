(function () {
  ...
  window.POFRAZE_FILMS = window.POFRAZE_FILMS.concat([
    ...
    f("silence-lambs", "Молчание ягнят", "The Silence of the Lambs", 1991, "фильм", ["dark", "mind-power", "slow"], ["завари мне ягнёнка", "кларисса", "Hannibal"], "Молчание ягнят"),
    ...
    f("rocky", "Рокки", "Rocky", 1976, "фильм", ["sport", "ambition", "family"], ["адриаан", "я не останусь на полу", "филадельфия"], "Рокки"),
    f("star-wars", "Звёздные войны: Новая надежда", "Star Wars", 1977, "фильм", ["fantasy", "space", "war"], ["да пребудет с тобой сила", "я твой отец", "это не та луна"], "Звёздные войны Новая надежда"),
    ...
    f("kill-bill", "Убить Билла", "Kill Bill", 2003, "фильм", ["tempo", "crime", "dark"], ["жёлтый комбинезон", "пять точка ла palma", "невеста"], "Убить Билла"),
    f("django", "Джанго освобождённый", "Django Unchained", 2012, "фильм", ["war", "crime", "irony"], ["я джанго", "зима", "кандинавский"], "Джанго освобождённый"),
    ...
    f("guardians", "Стражи Галактики", "Guardians of the Galaxy", 2014, "фильм", ["comedy", "space", "tempo"], ["я грант", "микс кассета", "дерево"], "Стражи Галактики"),
