(function () {
  ...
  function aboutView() {
    ...
    view.innerHTML =
      ...
      "<p>За помощь, когда казалось «ещё чуть-чуть и брошу». За мотивацию не оставлять фразу на середине. За любовь, которая теплее любого найденного тайтла. И за понимание: даже если я снова сижу над одной репликой допоздна.</p>" +
      "<p>Гузалия, ты — мой тихий свет и причина довести это до кнопки «Найти». Спасибо, что веришь в «По фразе» и в меня. Этот сайт — и тебе.</p>" +
      "</aside>" +
